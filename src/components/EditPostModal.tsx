      ...
      <div className="relative bg-white border border-gray-200 rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            <textarea
              className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all duration-200 min-h-[80px] resize-y"
              value={description}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {hashtags.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center gap-1 px-2.5 py-1 bg-violet-50 text-violet-600 text-xs rounded-full border border-violet-200"
                >
                  #{tag}
                  <button
                    type="button"
                    onClick={() => removeHashtag(tag)}
                    className="ml-0.5 hover:text-violet-900 cursor-pointer"
                  >
                    &times;
                  </button>
                </span>
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 p-5 border-t border-gray-100 sticky bottom-0 bg-gray-50 rounded-b-xl">
